...
const CancelSparkSubscription = ({ isOpen, onClose, authUser }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} p={0}>
            ...
            >
                <ModalCloseButton />
                <ModalHeader>Cancel Spark Subscription</ModalHeader>
                <ModalBody 
                    px={{ base: "8px", md: "8px" }} 
                    pt={{ base: 5, md: 5 }} 
                    pb={{ base: 4, md: 5 }}
...
export default CancelSparkSubscription;
